 ...
 */
const return_t_1 = require("./return.t");
/**
...
class URNReturn {
    ...
    inherit_res(result, name) {
        ...
        if (return_t_1.URNResponse.isFail(result)) {
        ...
        if (!return_t_1.URNResponse.isFail(result.payload) && !return_t_1.URNResponse.isSuccess(result.payload)) {
            return_result.message = (name) ? name + ' - ' + result.message : result.message;
            return return_result;
        }
        if (return_t_1.URNResponse.isFail(result.payload)) {
