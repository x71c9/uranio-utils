...
exports.browser_log_injector = exports.terminal_log_injector = void 0;
/*
 ...
 */
function log_param(p, stylelog) {
    let processed_param = [];
    if (p instanceof Error && p.stack != undefined) {
        processed_param = p.stack.split('\n');
    }
    else if (typeof p == 'object') {
        processed_param = formatter_1.jsonOneLine(p).split('\n');
    }
...
//# sourceMappingURL=console_injector.js.map